use qu_ast::type_hint::{IntegerWidth, Mutability};
...
impl TypeLayout {
    ...
    pub fn is_numeric_type(&self) -> bool {
        match self.kind {
            ...
            TypeKind::U8 | TypeKind::U32 | TypeKind::U16 | TypeKind::U64 => true,
            _ => false
        }
    }
    ...
    pub(crate) fn compare_numeric_widths(&self, source: &TypeLayout) -> i32 {
